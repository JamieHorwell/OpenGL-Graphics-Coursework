...
void main(void)	{
	//noise generation
	float n = noise(vec3(position.x + time / 100,position.z + time / 100,time / 100)/ 170.0) / 2.0 + noise(vec3(position.x + time / 60,position.z + time / 60,time / 60)/64.0) / 2.0
	+ noise(vec3(position.x + time / 40,position.z + time / 40,time / 40)/32.0) / 16.0;
