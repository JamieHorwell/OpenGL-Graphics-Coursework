...
void main(void){
	...
	FragColor[0] = vec4(lightColour.xyz * lambert * atten*1, 1.0);
	FragColor[1] = vec4(lightColour.xyz * sFactor * atten*1.73,1.0);
	
	//FragColor[0] = vec4(lightColour.xyz,1);
	//FragColor[1] = vec4(lightColour.xyz,1);
}